...
const CookieConsent: React.FC<CookieConsentProps> = ({ onAccept, onDecline }) => {
    ...
    return (
        <div className="fixed bottom-6 left-6 right-6 md:right-auto md:left-6 md:w-[480px] bg-[#121212] border border-brand-gold/30 rounded-xl shadow-[0_0_50px_rgba(0,0,0,0.8)] z-[500] animate-fade-in p-8 border-l-4 border-l-brand-gold text-left">
                ...
                <div className="flex-1 text-left">
                    ...
                    <div className="flex flex-col">
                        <button 
                            ...
                            className="w-full bg-gradient-to-r from-[#D4AF37] to-[#F4E0A1] text-zinc-400 font-black py-4 rounded uppercase tracking-[0.3em] text-[11px] hover:brightness-110 transition-all shadow-xl shadow-brand-gold/10"
                        >
